...
//
//	ScanWords | ScanInts | SkipComments
//
const (
	ScanWords     = 1 << -TokWord
	ScanInts       = 1 << -TokInt
...
type Scanner struct {
	...
	// indents shows previous indent levels to calculate how many dedents there
	// are when indentLevel < lastIndentLevel
	indents []int
...
// returns []rune since multiple dedents can be calculated 
...
// caveat: for array tokens such as multiple dedents, this won't work as expected
